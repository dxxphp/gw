            ...
            <div class="container">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span>您的位置：</span><?php echo W('Bread',array('id'=>$listid));?>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <ul class="right_new">
                              <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                    <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$table));?>" title="<?php echo ($vo["name"]); ?>"><?php echo (mb_substr($vo["name"],0,40,'utf-8')); ?></a>
...
<footer>
      <div class="container">    
            <div class="row">
                  <div class="col-xs-12 col-sm-3 col-md-3">
                        <img class="footer_logo" src="__ROOT__/Uploads/<?php echo W('Flash',array('type'=>3,'id'=>21));?>" alt="底部LOGO">
                  ...
                  <div class="col-xs-12 col-sm-3 col-md-3 footer_contact">
                        ...
                        <p><?php echo (C("web_icp")); ?>&nbsp;&nbsp;<a href="__ROOT__/sitemap.html" class="footer_sitemap" target="_blank">网站地图</a>&nbsp;<?php echo (C("web_count")); ?></p>
                  </div>
