            ...
            <div class="container">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span>您的位置：</span><a href="__ROOT__/">网站首页</a> &gt; 产品搜索
                              </div>
                        </div>
                  </div>
            </div>
            ...
            <div class="row">
                        ...
                        <div class="product_list product_list2">
                              <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-4 col-mm-6 product_img">
                                    ...
                                    <p class="product_title">
                                          <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'Product'));?>" title="<?php echo ($vo["name"]); ?>"><?php echo (mb_substr($vo["name"],0,20,'utf-8')); ?></a>
                                    </p>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-3">
                        ...
                        <div class="left_column">
                              <?php echo W('Left',array('id'=>$pid['id'],'type'=>'product'));?>
                        </div>
                        <div class="left_news">
