            ...
            <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <div class="product_list product_list2">
                              <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-4 col-mm-6 product_img">
                                    ...
                                    <p class="product_title">
                                          <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$table));?>" title="<?php echo ($vo["name"]); ?>"><?php echo (mb_substr($vo["name"],0,20,'utf-8')); ?></a>
                                    </p>
