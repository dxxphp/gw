          ...
          <td width="33%" height="24">
            <form method="get" action="__APP__">
              <div style="float:left; width:280px; height:24px;">
                ...
                下载搜索：<input type="text" name="keyword" class="FormSmall" style="height:12px;"></div>
...
<form name="theForm" id="theForm" method="post" action="">
  ...
  <div id="languageBox2">
    ...
    <?php if(is_array($down)): $i = 0; $__LIST__ = $down;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul onmouseover="this.style.background ='#FFFDD7'" onmouseout="this.style.background ='#FFFFFF'" style="height:30px;">
          ...
          <li class="li_40"><a href="<?php echo U('mod',array('id'=>$vo['id']));?>" title="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></a></li>
          <li class="li_40">
