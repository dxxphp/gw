...
<form action="<?php echo U('del',array('id'=>$feed['id']));?>" method="post" name="myform">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ListCategory" style="margin-top:10px;">
		...
		<?php if(is_array($formdata)): $i = 0; $__LIST__ = $formdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="firstalt">
				<td width="100" height="30"><span style="padding-left:10px;"><?php echo ($vo["name"]); ?>：</span></td>
