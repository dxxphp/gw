...
body{background: url(../Public/images/blue_2010/) repeat-x top center; background-color:#fff;}
.login_box{margin:0 auto; width:1024px; height:600px;  background:url(../Public/images/blue_2010/WechatIMG393.png) no-repeat;}
.login_text{font-size:13px; color:#075398; width:270px; padding:150px 0px 0px 470px; line-height:22px;}
