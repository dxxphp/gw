...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <div class="tablelisthead">
    <ul pid='0'>
      ...
      <li class="li_10">联系人</li>
      <li class="li_25">日期</li>
  ...
  <div id="languageBox2">
    ...
    <?php if(is_array($inquiry)): $i = 0; $__LIST__ = $inquiry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul onmouseover="this.style.background ='#FFFDD7'" onmouseout="this.style.background ='#FFFFFF'" style="height:55px;">
          ...
          <li class="li_30"><a href="<?php echo U('view',array('id'=>$vo['id']));?>" title="<?php echo ($vo["product"]); ?>"><?php echo (mb_substr($vo["product_name"],0,20,'utf-8')); ?></a><img src="__ROOT__/Uploads/<?php echo ($vo["thumb"]); ?>" class="proimg"/></li>
          <li class="li_10"><?php echo ($vo["name"]); ?></li>
          <li class="li_25"><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></li>
          <li class="li_25">
